...
Airbnfarm is a web application inspired by Airbnb and built using Ruby on Rails and React/Redux. By the end of Week 9, this app will, at a minimum, satisfy the
